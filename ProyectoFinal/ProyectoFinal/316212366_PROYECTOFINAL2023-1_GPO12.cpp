...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "316212366_PROYECTOFINAL2023-1_GPO12", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Flor 1
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-8.90f, 1.36f - desp, -0.3523f - desp2));
		...
		//Flor 2
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-8.90f, 1.31f - desp - desp2, -0.394f + desp2));
		glUniform1f(glGetUniformLocation(Animacion.Program, "time"), tiempo);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Flor.Draw(Animacion);
		//Flor 3
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-8.90f, 1.273f - desp - desp2, -0.461f - desp2));
		glUniform1f(glGetUniformLocation(Animacion.Program, "time"), tiempo);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Flor.Draw(Animacion);
		//Flor 4
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-8.90f, 1.288f - desp, -0.524f + desp2));
		glUniform1f(glGetUniformLocation(Animacion.Program, "time"), tiempo);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Flor.Draw(Animacion);
		glBindVertexArray(0);
